...
class NetAgent(Agent):
    ...
    def make_link(self, partner):
        ...
        if self.model.ml.net.has_edge(self,partner):
            self.model.ml.net[self][partner]["trades"] += 1
        else:
            self.model.ml.net.add_edge(self, partner, trades = 1)
    ...
    def collect(self):
        ...
        for res in this_cell:
            if res.type == "resource":
                self.accumulations[1] += res.value_sug 
                self.accumulations[2] += res.value_spice
                res.value_sug = 0
                res.value_spice = 0
    ...
    def eat(self):
        ...
        self.accumulations[1] -= self.metabolism["sug_bolism"]
        self.accumulations[2] -= self.metabolism["spice_bolism"]
