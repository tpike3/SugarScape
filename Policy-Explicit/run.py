...
pickle.dump(type_df, open("brute_type_df_10.p", "wb"))
pickle.dump(price_df, open("brute_total_price_10.p", "wb"))
pickle.dump(survivors, open("brute_multi_sur_10.p", "wb" ))
pickle.dump(time2, open("brute_multi_time_10.p", "wb"))
