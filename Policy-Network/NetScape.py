...
class NetScape(Model):
    ...
    def step(self):
        ...
        #print (len(self.ml.schedule))
        #self.last = len(self.ml.schedule)
        
        #print ("Price Recorder: ", len(self.price_record[self.step_num]))
               
        
        #recorder.get_price(self)
        #print ("num meta agents ", self.ml.active_agent_count)
        #print ("num links", self.ml.net.number_of_edges())
        #print ("\n")
