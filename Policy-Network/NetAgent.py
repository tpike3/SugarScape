    ...
    def move(self):
       ...
       # print ([self.assess_sustenance(pos) for pos in neighbors])
        ...
        if final_candidates[0] == self.pos: 
            ...
            #self.model.ml.remove_link([(self,self.model.ml._agents[self.pos])])
            self.model.grid.move_agent(self, final_candidates[0])
            #self.model.ml.add_link([(self, self.model.ml._agents[final_candidates[0]],\
                                  #   {"places": final_candidates[0]})])
